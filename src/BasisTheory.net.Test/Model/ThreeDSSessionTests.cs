...
namespace BasisTheory.net.Test.Model
{
    ...
    public class ThreeDSSessionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" ThreeDSSession
            //Assert.IsType<ThreeDSSession>(instance);
        }
