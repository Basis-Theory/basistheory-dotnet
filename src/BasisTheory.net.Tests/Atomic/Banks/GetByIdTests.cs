...
public class GetByIdTests : IClassFixture<AtomicBankFixture>
{
        ...
        get
        {
            yield return new object[]
            {
                (Func<IAtomicBankClient, Guid, BankGetByIdRequest, RequestOptions, Task<AtomicBank>>) (
                    async (client, atomicBankId, request, options) =>
                        await client.GetByIdAsync(atomicBankId, request, options)
                )
            };
            yield return new object[]
            {
                (Func<IAtomicBankClient, Guid, BankGetByIdRequest, RequestOptions, Task<AtomicBank>>) (
                    async (client, atomicBankId, request, options) =>
                        await client.GetByIdAsync(atomicBankId.ToString(), request, options)
                )
            };
            yield return new object[]
            {
                (Func<IAtomicBankClient, Guid, BankGetByIdRequest, RequestOptions, Task<AtomicBank>>) (
                    (client, atomicBankId, request, options) =>
                        Task.FromResult(client.GetById(atomicBankId, request, options))
                )
            };
            yield return new object[]
            {
                (Func<IAtomicBankClient, Guid, BankGetByIdRequest, RequestOptions, Task<AtomicBank>>) (
                    (client, atomicBankId, request, options) =>
                        Task.FromResult(client.GetById(atomicBankId.ToString(), request, options))
                )
            };
        }
    }
    ...
    public async Task ShouldGetById(
        Func<IAtomicBankClient, Guid, BankGetByIdRequest, RequestOptions, Task<AtomicBank>> mut)
    {
