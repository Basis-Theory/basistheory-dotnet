...
namespace BasisTheory.net.Tests.Atomic.Cards
{
    public class CreateTests : IClassFixture<AtomicCardFixture>
    {
            ...
            get
            {
                yield return new object []
                {
                    (Func<IAtomicCardClient, AtomicCard, RequestOptions, Task<AtomicCard>>)(
                        async (client, atomicCard, options) => await client.CreateAsync(atomicCard, options)
                    )
                };
                yield return new object []
                {
                    (Func<IAtomicCardClient, AtomicCard, RequestOptions, Task<AtomicCard>>)(
                        (client, atomicCard, options) => Task.FromResult(client.Create(atomicCard, options))
                    )
                };
            }
        }
        ...
        public async Task ShouldCreate(Func<IAtomicCardClient, AtomicCard, RequestOptions, Task<AtomicCard>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldCreateWithPerRequestApiKey(Func<IAtomicCardClient, AtomicCard, RequestOptions, Task<AtomicCard>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldCreateWithCorrelationId(Func<IAtomicCardClient, AtomicCard, RequestOptions, Task<AtomicCard>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldBubbleUpBasisTheoryErrors(Func<IAtomicCardClient, AtomicCard, RequestOptions, Task<AtomicCard>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldHandleNonBasisTheoryErrorResponse(Func<IAtomicCardClient, AtomicCard, RequestOptions, Task<AtomicCard>> mut)
        {
