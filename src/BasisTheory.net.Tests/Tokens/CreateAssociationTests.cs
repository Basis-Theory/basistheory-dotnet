...
public class CreateAssociationTests : IClassFixture<TokenFixture>
{
    ...
    public static IEnumerable<object[]> Methods
    {
        get
        {
            ...
            yield return new object[]
            {
                (Func<ITokenClient, string, string, RequestOptions, Task>) (
                    async (client, parentTokenId, childTokenId, options) =>
                        await client.CreateAssociationAsync(parentTokenId.ToString(), childTokenId.ToString(),
                            options)
                )
            };
            yield return new object[]
            ...
            yield return new object[]
            {
                (Func<ITokenClient, string, string, RequestOptions, Task>) (
                    (client, parentTokenId, childTokenId, options) =>
                        Task.Run(() =>
                            client.CreateAssociation(parentTokenId.ToString(), childTokenId.ToString(), options))
                )
            };
        }
    }
    ...
    public async Task ShouldCreateAssociation(Func<ITokenClient, string, string, RequestOptions, Task> mut)
    {
    ...
    [Theory]
    [MemberData(nameof(Methods))]
    public async Task ShouldCreateAssociationWithPerRequestApiKey(
    ...
    [Theory]
    [MemberData(nameof(Methods))]
    public async Task ShouldCreateAssociationWithCorrelationId(
        Func<ITokenClient, string, string, RequestOptions, Task> mut)
    {
