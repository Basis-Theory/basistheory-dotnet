...
public static class ApplicationFactory
{
    ...
    public static readonly Faker<AccessRule> AccessRuleFaker = new Faker<AccessRule>()
        ...
        .RuleFor(a => a.Conditions, (f, _) => new List<Condition> { Condition() });

    public static readonly Faker<Condition> ConditionFaker = new Faker<Condition>()
        .RuleFor(c => c.Attribute, (f, _) => f.Lorem.Word())
        .RuleFor(c => c.Operator, (f, _) => f.Lorem.Word())
        .RuleFor(c => c.Value, (f, _) => f.Lorem.Word());

    public static readonly Faker<PaginatedList<Application>> PaginatedListFaker =
        new Faker<PaginatedList<Application>>()
    ...
    public static PaginatedList<Application> PaginatedApplications(
        Action<PaginatedList<Application>> applyOverrides = null)
    {
    ...
    public static Condition Condition(Action<Condition> applyOverrides = null)
    {
        var condition = ConditionFaker.Generate();

        applyOverrides?.Invoke(condition);
