...
{
    public class UpdateTests : IClassFixture<ReactorFormulaFixture>
    {
        readonly ReactorFormulaFixture fixture;

        public UpdateTests(ReactorFormulaFixture fixture)
        {
        ...
        public async Task ShouldUpdate(Func<IReactorFormulaClient, ReactorFormula, RequestOptions, Task<ReactorFormula>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldUpdateWithPerRequestApiKey(Func<IReactorFormulaClient, ReactorFormula, RequestOptions, Task<ReactorFormula>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldUpdateWithCorrelationId(Func<IReactorFormulaClient, ReactorFormula, RequestOptions, Task<ReactorFormula>> mut)
        {
        ...
        public async Task ShouldBubbleUpBasisTheoryErrors(Func<IReactorFormulaClient, ReactorFormula, RequestOptions, Task<ReactorFormula>> mut)
        {
            ...
            var exception = await Assert.ThrowsAsync<BasisTheoryException>(() => mut(fixture.Client, new ReactorFormula(), null));
