...
namespace BasisTheory.net.Tests.Tenants
{
    public class GetSelfTests : IClassFixture<TenantFixture>
    {
        ...
        public async Task ShouldGetTenantForSelf(Func<ITenantClient, RequestOptions, Task<Tenant>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldGetTenantForSelfWithPerRequestApiKey(Func<ITenantClient, RequestOptions, Task<Tenant>> mut)
        {
        ...
        [Theory]
        [MemberData(nameof(Methods))]
        public async Task ShouldGetTenantForSelfWithCorrelationId(Func<ITenantClient, RequestOptions, Task<Tenant>> mut)
        {
