...
namespace BasisTheory.net.Api
{
    ...
    public interface IPermissionsApiSync : IApiAccessor
    {
        ...
        List<Permission> Get(string applicationType = default(string), int operationIndex = 0, BasisTheory.net.Client.RequestOptions requestOptions = default(BasisTheory.net.Client.RequestOptions));
        ...
        ApiResponse<List<Permission>> GetWithHttpInfo(string applicationType = default(string), int operationIndex = 0, BasisTheory.net.Client.RequestOptions requestOptions = default(BasisTheory.net.Client.RequestOptions));
    ...
    public partial class PermissionsApi : IPermissionsApi
    {
        ...
        /// <param name="requestOptions"></param>
        /// <returns>List&lt;Permission&gt;</returns>
        public List<Permission> Get(string applicationType = default(string), int operationIndex = 0, BasisTheory.net.Client.RequestOptions requestOptions = default(BasisTheory.net.Client.RequestOptions))
        {
            BasisTheory.net.Client.ApiResponse<List<Permission>> localVarResponse = GetWithHttpInfo(applicationType, operationIndex, requestOptions);
        ...
        /// <param name="requestOptions"></param>
        /// <returns>ApiResponse of List&lt;Permission&gt;</returns>
        public BasisTheory.net.Client.ApiResponse<List<Permission>> GetWithHttpInfo(string applicationType = default(string), int operationIndex = 0, BasisTheory.net.Client.RequestOptions requestOptions = default(BasisTheory.net.Client.RequestOptions))
        {
            ...
            {
                requestOptions.QueryParameters.Add(BasisTheory.net.Client.ClientUtils.ParameterToMultiMap("", "application_type", applicationType));
            }

            requestOptions.Operation = "PermissionsApi.Get";
            ...
            var localVarResponse = this.Client.Get<List<Permission>>("/permissions", requestOptions, this.Configuration);
        ...
        {
            BasisTheory.net.Client.ApiResponse<List<Permission>> localVarResponse = await GetWithHttpInfoAsync(applicationType, operationIndex, requestOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<BasisTheory.net.Client.ApiResponse<List<Permission>>> GetWithHttpInfoAsync(string applicationType = default(string), int operationIndex = 0, BasisTheory.net.Client.RequestOptions requestOptions = default(BasisTheory.net.Client.RequestOptions), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<Permission>>("/permissions", requestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
