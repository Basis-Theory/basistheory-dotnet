...
namespace BasisTheory.net.Api
{
    ...
    public interface IRolesApiSync : IApiAccessor
    {
        ...
        List<Role> Get(int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions));
        ...
        ApiResponse<List<Role>> GetWithHttpInfo(int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions));
    ...
    public interface IRolesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Role>> GetAsync(int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Role>>> GetWithHttpInfoAsync(int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class RolesApi : IRolesApi
    {
        ...
        /// <param name="localVarRequestOptions"></param>
        /// <returns>List&lt;Role&gt;</returns>
        public List<Role> Get(int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions))
        {
            BasisTheory.net.Client.ApiResponse<List<Role>> localVarResponse = GetWithHttpInfo(operationIndex, localVarRequestOptions);
        ...
        /// <param name="localVarRequestOptions"></param>
        /// <returns>ApiResponse of List&lt;Role&gt;</returns>
        public BasisTheory.net.Client.ApiResponse<List<Role>> GetWithHttpInfo(int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions))
        {
            ...
            localVarRequestOptions.Operation = "RolesApi.Get";
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Role&gt;</returns>
        public async System.Threading.Tasks.Task<List<Role>> GetAsync(int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            BasisTheory.net.Client.ApiResponse<List<Role>> localVarResponse = await GetWithHttpInfoAsync(operationIndex, localVarRequestOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
