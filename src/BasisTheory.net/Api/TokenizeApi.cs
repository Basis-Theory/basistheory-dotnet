...
namespace BasisTheory.net.Api
{
    ...
    public interface ITokenizeApiSync : IApiAccessor
    {
        ...
        Object Tokenize(Object body = default(Object), int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions));
        ...
        ApiResponse<Object> TokenizeWithHttpInfo(Object body = default(Object), int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions));
    ...
    public interface ITokenizeApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Object> TokenizeAsync(Object body = default(Object), int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TokenizeApi : ITokenizeApi
    {
        ...
        /// <param name="localVarRequestOptions"></param>
        /// <returns>Object</returns>
        public Object Tokenize(Object body = default(Object), int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions))
        {
            BasisTheory.net.Client.ApiResponse<Object> localVarResponse = TokenizeWithHttpInfo(body, operationIndex, localVarRequestOptions);
        ...
        /// <param name="localVarRequestOptions"></param>
        /// <returns>ApiResponse of Object</returns>
        public BasisTheory.net.Client.ApiResponse<Object> TokenizeWithHttpInfo(Object body = default(Object), int operationIndex = 0, BasisTheory.net.Client.RequestOptions localVarRequestOptions = default(BasisTheory.net.Client.RequestOptions))
        {
        ...
        {
            BasisTheory.net.Client.ApiResponse<Object> localVarResponse = await TokenizeWithHttpInfoAsync(body, operationIndex, localVarRequestOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
