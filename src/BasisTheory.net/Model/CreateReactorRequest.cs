...
namespace BasisTheory.net.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateReactorRequest :  IEquatable<CreateReactorRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateReactorRequest(string name = default(string), string code = default(string), Application application = default(Application), Dictionary<string, string> configuration = default(Dictionary<string, string>))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateReactorRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for CreateReactorRequest and cannot be null");
            }
            else
            {
                this.Code = code;
