...
namespace BasisTheory.net.Reactors
{
    ...
    {
        Reactor GetById(Guid reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null);
        Reactor GetById(string reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null);
        Task<Reactor> GetByIdAsync(Guid reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null, CancellationToken cancellationToken = default);
        Task<Reactor> GetByIdAsync(string reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null, CancellationToken cancellationToken = default);

        PaginatedList<Reactor> Get(ReactorGetRequest request = null, RequestOptions requestOptions = null);
        Task<PaginatedList<Reactor>> GetAsync(ReactorGetRequest request = null, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default);

        Reactor Create(Reactor reactor, RequestOptions requestOptions = null);
        Task<Reactor> CreateAsync(Reactor reactor, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default);
        ...
        Task<Reactor> UpdateAsync(Guid reactorId, Reactor reactor, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default);
        Task<Reactor> UpdateAsync(string reactorId, Reactor reactor, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default);
        ...
        Task DeleteAsync(Guid reactorId, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default);
        Task DeleteAsync(string reactorId, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default);
    }
    ...
    public class ReactorClient : BaseClient, IReactorClient
    {
        ...
        public Reactor GetById(Guid reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null)
        {
            return GetById(reactorId.ToString(), request, requestOptions);
        }

        public Reactor GetById(string reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null)
        {
            return Get<Reactor>($"{BasePath}/{reactorId}", request, requestOptions);
        }

        public async Task<Reactor> GetByIdAsync(Guid reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
            return await GetByIdAsync(reactorId.ToString(), request, requestOptions, cancellationToken);
        }

        public async Task<Reactor> GetByIdAsync(string reactorId, ReactorGetByIdRequest request = null,
            RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<PaginatedList<Reactor>> GetAsync(ReactorGetRequest request = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Reactor> CreateAsync(Reactor reactor, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Reactor> UpdateAsync(Guid reactorId, Reactor reactor,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task<Reactor> UpdateAsync(string reactorId, Reactor reactor,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
        ...
        public async Task DeleteAsync(Guid reactorId, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
            await DeleteAsync(reactorId.ToString(), requestOptions, cancellationToken);
        }

        public new async Task DeleteAsync(string reactorId, RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default)
        {
