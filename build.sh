...
${nuget_cmd} install src/BasisTheory.net/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/BasisTheory.net.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/BasisTheory.net.dll \
-recurse:'src/BasisTheory.net/*.cs' \
-doc:bin/BasisTheory.net.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/BasisTheory.net.dll was created successfully"
fi
